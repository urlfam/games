...
async function testExtraction() {
  ...
  const gamePageUrl =
    'https://games.crazygames.com/fr_FR/master-of-numbers-qmz/index.html';
  ...
  try {
    ...
    if (match && match[1]) {
      ...
      console.log(
        'Cela signifie que la structure de la page a peut-être changé, ou que nous sommes encore bloqués.',
      );
    }
  } catch (error) {
