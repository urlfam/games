...
const testGame = {
  ...
  iframe_url:
    'https://games.crazygames.com/en_US/card-solitaire-word-game/index.html',
  image_url:
    'https://imgs.crazygames.com/card-solitaire-word-game_16x9/20251202095711/card-solitaire-word-game_16x9-cover',
...
const categoryLink = `<a href="/c/${categorySlug}" class="text-purple-400 hover:text-purple-300 underline font-semibold transition-colors">${testGame.category} games collection</a>`;
finalDescription = finalDescription.replace(
  /\{\{CATEGORY_LINK\}\}/g,
  categoryLink,
);
console.log(
  `✅ CATEGORY_LINK remplacé par: ${testGame.category} games collection`,
);
